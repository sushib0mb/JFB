...
class _SurveyPageState extends State<SurveyPage> {
  ...
  Widget _buildRadioGroup(String title, List<String> options, String? groupVal,
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              _buildRadioGroup("What is your gender?", [
                "Male",
                "Female",
                "Prefer not to say",
                "Other"
              ], gender, (val) => setState(() => gender = val), genderOther),

              _buildRadioGroup("Where are you coming from?", [
                "Massachusetts",
                "Rhode Island",
                "New Hampshire",
                "Other"
              ], from, (val) => setState(() => from = val), fromOther),

              _buildRadioGroup("How did you hear about us?", [
                "Twitter",
                "Facebook",
                "Official Website",
                "Friend",
                "Other"
              ], heardFrom, (val) => setState(() => heardFrom = val), heardOther),

              _buildRadioGroup("What were you looking forward to most?", [
                "Stage",
                "Food",
                "Culture",
                "Activities",
                "Booth",
                "Other"
              ], lookingForward, (val) => setState(() => lookingForward = val), lookingOther),

              _buildRadioGroup("Age?", [
                "11-19",
                "20-29",
                "30-39",
                "40-49",
                ...
                "60-69",
                "70-"
              ], age, (val) => setState(() => age = val)),

              _buildRadioGroup("Did you come with", [
                "Family",
                "Friends",
                "On your own",
                "Other"
              ], cameWith, (val) => setState(() => cameWith = val), cameWithOther),

              _buildRadioGroup("Did you participate in the past?", [
                "First time!",
                "2nd or 3rd time",
                "4 time or more"
              ], participated, (val) => setState(() => participated = val)),
